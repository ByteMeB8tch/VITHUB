...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!vitResponse.ok) {
        throw new Error("Invalid VIT credentials")
      }

      const { data: vitData } = await vitResponse.json()
      console.log("VIT authentication successful:", vitData)
      ...
      setError(err.message || "Invalid VIT credentials. Please check your registration number and password.")
    } finally {
      setIsLoading(false)
    }
  }
